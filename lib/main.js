...
module.exports = React.createClass({
  ...
  getInputKeydownMap: function() {

    if(this.props.inputKeydownMap === undefined) {
      return {
          8: 'removeLastToken', //backspace
          9: 'selectOnEnter', //tab
          13: 'selectOnEnter', //enter
          27: 'hideOnEscape', //escape
          32: 'selectOnEnter', //spacebar
          38: 'focusPrevious', //up arrow
          40: 'focusNext', //down arrow
          186: 'selectOnEnter', //semi-colon
          188: 'selectOnEnter' //comma
      }
    }

    return this.props.inputKeydownMap
  },
    ...
    return ul({className: classes, onClick: this.handleClick},
      ...
      li({className: 'inline-flex', ref: 'combo-li'},
        Combobox({
          ...
          inputKeydownMap: this.getInputKeydownMap()
        },
